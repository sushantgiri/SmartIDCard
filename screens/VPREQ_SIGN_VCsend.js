...
export default class VPREQ_SIGN_VCsend extends React.Component {
    state = {
    password: '',
    dataKey: '',
    address: '',
  ...
  makeVCJWTandSign = async (vcjwtArray) => {
    ...
    const dualDid = new DualDID(dualSigner, webConfig.issuerName, webConfig.serviceEndPoint,web3,webConfig.VPREQ_SIGN_VC_SEND_ADDRESS)
